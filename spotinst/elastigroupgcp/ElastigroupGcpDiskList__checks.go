...
func (e *jsiiProxy_ElastigroupGcpDiskList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupGcpDiskList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
