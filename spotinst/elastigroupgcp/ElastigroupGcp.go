...
type ElastigroupGcp interface {
	...
	RevertToPreemptible() ElastigroupGcpRevertToPreemptibleList
...
func (j *jsiiProxy_ElastigroupGcp) OptimizationWindows() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"optimizationWindows",
...
func (j *jsiiProxy_ElastigroupGcp) OptimizationWindowsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ElastigroupGcp) RevertToPreemptible() ElastigroupGcpRevertToPreemptibleList {
	var returns ElastigroupGcpRevertToPreemptibleList
	_jsii_.Get(
		j,
		"revertToPreemptible",
		&returns,
...
func (j *jsiiProxy_ElastigroupGcp) RevertToPreemptibleInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.220.0/docs/resources/elastigroup_gcp spotinst_elastigroup_gcp} Resource.
...
func (j *jsiiProxy_ElastigroupGcp)SetOptimizationWindows(val *[]*string) {
...
func ElastigroupGcp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateElastigroupGcp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElastigroupGcp) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_ElastigroupGcp) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_ElastigroupGcp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_ElastigroupGcp) MoveFromId(id *string) {
...
func (e *jsiiProxy_ElastigroupGcp) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_ElastigroupGcp) MoveToId(id *string) {
...
func (e *jsiiProxy_ElastigroupGcp) PutRevertToPreemptible(value interface{}) {
...
func (e *jsiiProxy_ElastigroupGcp) ResetOptimizationWindows() {
	_jsii_.InvokeVoid(
		e,
		"resetOptimizationWindows",
		nil, // no parameters
...
func (e *jsiiProxy_ElastigroupGcp) ResetRevertToPreemptible() {
	_jsii_.InvokeVoid(
		e,
		"resetRevertToPreemptible",
		nil, // no parameters
...
func (e *jsiiProxy_ElastigroupGcp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_ElastigroupGcp) ToHclTerraform() interface{} {
	var returns interface{}
