...
func (e *jsiiProxy_ElastigroupGcpScalingDownPolicyDimensionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElastigroupGcpScalingDownPolicyDimensionsList) Resolve(context cdktf.IResolveContext) interface{} {
