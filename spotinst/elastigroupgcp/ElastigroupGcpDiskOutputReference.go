...
func (e *jsiiProxy_ElastigroupGcpDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ElastigroupGcpDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
