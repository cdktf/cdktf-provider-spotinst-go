...
func (s *jsiiProxy_StatefulNodeAzureVmSizesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulNodeAzureVmSizesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
