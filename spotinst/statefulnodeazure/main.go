...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "shouldPersistVm", GoGetter: "ShouldPersistVm"},
			_jsii_.MemberProperty{JsiiProperty: "shouldPersistVmInput", GoGetter: "ShouldPersistVmInput"},
