...
func (s *jsiiProxy_StatefulNodeAzureNetworkNetworkInterfaceAdditionalIpConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StatefulNodeAzureNetworkNetworkInterfaceAdditionalIpConfigurationsList) Resolve(context cdktf.IResolveContext) interface{} {
