...
type StatefulNodeAzureSecretVaultCertificatesList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) StatefulNodeAzureSecretVaultCertificatesOutputReference
...
// The jsii proxy struct for StatefulNodeAzureSecretVaultCertificatesList
type jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList) InternalValue() interface{} {
...
func (j *jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewStatefulNodeAzureSecretVaultCertificatesList_Override(s StatefulNodeAzureSecretVaultCertificatesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (s *jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_StatefulNodeAzureSecretVaultCertificatesList) ToString() *string {
	var returns *string
