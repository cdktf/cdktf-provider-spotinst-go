...
func (s *jsiiProxy_StatefulNodeAzureSecurityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulNodeAzureSecurityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
