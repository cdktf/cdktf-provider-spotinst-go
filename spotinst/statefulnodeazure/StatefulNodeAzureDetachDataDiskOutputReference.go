...
func (s *jsiiProxy_StatefulNodeAzureDetachDataDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulNodeAzureDetachDataDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
