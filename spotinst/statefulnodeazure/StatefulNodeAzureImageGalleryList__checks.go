...
func (s *jsiiProxy_StatefulNodeAzureImageGalleryList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_StatefulNodeAzureImageGalleryList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
