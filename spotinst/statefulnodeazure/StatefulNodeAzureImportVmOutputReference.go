...
func (s *jsiiProxy_StatefulNodeAzureImportVmOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulNodeAzureImportVmOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
