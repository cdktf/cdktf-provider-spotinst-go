...
func (s *jsiiProxy_StatefulNodeAzureHealthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulNodeAzureHealthOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
