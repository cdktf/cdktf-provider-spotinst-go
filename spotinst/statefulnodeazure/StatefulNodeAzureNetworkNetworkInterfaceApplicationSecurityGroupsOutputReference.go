...
func NewStatefulNodeAzureNetworkNetworkInterfaceApplicationSecurityGroupsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StatefulNodeAzureNetworkNetworkInterfaceApplicationSecurityGroupsOutputReference {
	...
	if err := validateNewStatefulNodeAzureNetworkNetworkInterfaceApplicationSecurityGroupsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StatefulNodeAzureNetworkNetworkInterfaceApplicationSecurityGroupsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StatefulNodeAzureNetworkNetworkInterfaceApplicationSecurityGroupsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
