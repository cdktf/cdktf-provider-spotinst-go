...
func (s *jsiiProxy_StatefulNodeAzureDetachDataDiskList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_StatefulNodeAzureDetachDataDiskList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
