...
func (s *jsiiProxy_StatefulNodeAzureNetworkNetworkInterfaceList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_StatefulNodeAzureNetworkNetworkInterfaceList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
