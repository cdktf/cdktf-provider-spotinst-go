...
func (s *jsiiProxy_StatefulNodeAzureProximityPlacementGroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StatefulNodeAzureProximityPlacementGroupsList) Resolve(context cdktf.IResolveContext) interface{} {
