...
func (s *jsiiProxy_StatefulNodeAzureImageCustomImageList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_StatefulNodeAzureImageCustomImageList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
