...
func (s *jsiiProxy_StatefulNodeAzureSecretSourceVaultList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_StatefulNodeAzureSecretSourceVaultList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
