...
// Represents a {@link https://registry.terraform.io/providers/spotinst/spotinst/1.189.0/docs/resources/ocean_gke_import spotinst_ocean_gke_import}.
...
// Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.189.0/docs/resources/ocean_gke_import spotinst_ocean_gke_import} Resource.
...
func (o *jsiiProxy_OceanGkeImport) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OceanGkeImport) MoveFromId(id *string) {
...
func (o *jsiiProxy_OceanGkeImport) MoveToId(id *string) {
...
func (o *jsiiProxy_OceanGkeImport) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OceanGkeImport) ToHclTerraform() interface{} {
	var returns interface{}
