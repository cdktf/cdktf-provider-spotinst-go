...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationUserGroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OrganizationUserGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-spotinst.organizationUserGroup.OrganizationUserGroupPolicies",
		reflect.TypeOf((*OrganizationUserGroupPolicies)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.organizationUserGroup.OrganizationUserGroupPoliciesList",
		reflect.TypeOf((*OrganizationUserGroupPoliciesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationUserGroupPoliciesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
