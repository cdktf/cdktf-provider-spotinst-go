...
type OceancdVerificationTemplateMetricsProviderWebWebHeader struct {
	...
	WebHeaderKey *string `field:"required" json:"webHeaderKey" yaml:"webHeaderKey"`
	...
	WebHeaderValue *string `field:"required" json:"webHeaderValue" yaml:"webHeaderValue"`
}
