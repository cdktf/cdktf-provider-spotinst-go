...
func (o *jsiiProxy_OceancdStrategyRollingStepsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceancdStrategyRollingStepsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
