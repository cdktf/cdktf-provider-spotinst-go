...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationUser)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OrganizationUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-spotinst.organizationUser.OrganizationUserPolicies",
		reflect.TypeOf((*OrganizationUserPolicies)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.organizationUser.OrganizationUserPoliciesList",
		reflect.TypeOf((*OrganizationUserPoliciesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationUserPoliciesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
