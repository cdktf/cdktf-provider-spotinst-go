...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OrganizationPolicyPolicyContent)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.organizationPolicy.OrganizationPolicyPolicyContentList",
		reflect.TypeOf((*OrganizationPolicyPolicyContentList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationPolicyPolicyContentOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OrganizationPolicyPolicyContentStatements)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.organizationPolicy.OrganizationPolicyPolicyContentStatementsList",
		reflect.TypeOf((*OrganizationPolicyPolicyContentStatementsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrganizationPolicyPolicyContentStatementsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
