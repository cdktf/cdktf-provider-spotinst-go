...
func (m *jsiiProxy_MrscalerAwsMasterEbsBlockDeviceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MrscalerAwsMasterEbsBlockDeviceList) Resolve(context cdktf.IResolveContext) interface{} {
