...
// Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.208.0/docs/resources/mrscaler_aws spotinst_mrscaler_aws} Resource.
...
func MrscalerAws_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMrscalerAws_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MrscalerAws) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MrscalerAws) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MrscalerAws) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MrscalerAws) MoveFromId(id *string) {
...
func (m *jsiiProxy_MrscalerAws) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MrscalerAws) MoveToId(id *string) {
...
func (m *jsiiProxy_MrscalerAws) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MrscalerAws) ToHclTerraform() interface{} {
	var returns interface{}
