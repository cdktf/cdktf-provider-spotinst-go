...
func (m *jsiiProxy_MrscalerAwsCoreScalingDownPolicyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (m *jsiiProxy_MrscalerAwsCoreScalingDownPolicyList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
