...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SpotinstProvider)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "featureFlags", GoGetter: "FeatureFlags"},
			_jsii_.MemberProperty{JsiiProperty: "featureFlagsInput", GoGetter: "FeatureFlagsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFeatureFlags", GoMethod: "ResetFeatureFlags"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SpotinstProviderConfig)(nil)).Elem(),
	)
}
