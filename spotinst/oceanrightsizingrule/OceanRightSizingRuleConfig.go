...
type OceanRightSizingRuleConfig struct {
	...
	AutoApplyDefinition interface{} `field:"optional" json:"autoApplyDefinition" yaml:"autoApplyDefinition"`
	...
	DownsideOnly interface{} `field:"optional" json:"downsideOnly" yaml:"downsideOnly"`
	...
	ExcludePreliminaryRecommendations interface{} `field:"optional" json:"excludePreliminaryRecommendations" yaml:"excludePreliminaryRecommendations"`
	...
	RecommendationApplicationHpa interface{} `field:"optional" json:"recommendationApplicationHpa" yaml:"recommendationApplicationHpa"`
	...
	RestartReplicas *string `field:"optional" json:"restartReplicas" yaml:"restartReplicas"`
}
