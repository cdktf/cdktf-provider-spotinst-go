...
func NewOceanEcsLaunchSpecSchedulingTaskTaskHeadroomList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) OceanEcsLaunchSpecSchedulingTaskTaskHeadroomList {
	...
	if err := validateNewOceanEcsLaunchSpecSchedulingTaskTaskHeadroomListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OceanEcsLaunchSpecSchedulingTaskTaskHeadroomList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OceanEcsLaunchSpecSchedulingTaskTaskHeadroomList) Resolve(context cdktf.IResolveContext) interface{} {
