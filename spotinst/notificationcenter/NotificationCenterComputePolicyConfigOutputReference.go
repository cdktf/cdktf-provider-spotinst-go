...
func (n *jsiiProxy_NotificationCenterComputePolicyConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NotificationCenterComputePolicyConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
