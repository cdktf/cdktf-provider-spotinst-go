...
func (j *jsiiProxy_OceanAksNpFiltersOutputReference) GpuTypes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"gpuTypes",
...
func (j *jsiiProxy_OceanAksNpFiltersOutputReference) GpuTypesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"gpuTypesInput",
...
func (j *jsiiProxy_OceanAksNpFiltersOutputReference)SetGpuTypes(val *[]*string) {
...
func (o *jsiiProxy_OceanAksNpFiltersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanAksNpFiltersOutputReference) ResetGpuTypes() {
	_jsii_.InvokeVoid(
		o,
		"resetGpuTypes",
		nil, // no parameters
...
func (o *jsiiProxy_OceanAksNpFiltersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
