...
// Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.117.0/docs/resources/ocean_aks_np spotinst_ocean_aks_np} Resource.
...
func (o *jsiiProxy_OceanAksNp) ResetAvailabilityZones() {
	_jsii_.InvokeVoid(
		o,
		"resetAvailabilityZones",
		nil, // no parameters
