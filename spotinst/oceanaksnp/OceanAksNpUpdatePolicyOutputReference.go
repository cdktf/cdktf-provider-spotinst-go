...
func (o *jsiiProxy_OceanAksNpUpdatePolicyOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanAksNpUpdatePolicyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
