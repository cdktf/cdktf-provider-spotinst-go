...
func (o *jsiiProxy_OceanAksNpAutoscalerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanAksNpAutoscalerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
