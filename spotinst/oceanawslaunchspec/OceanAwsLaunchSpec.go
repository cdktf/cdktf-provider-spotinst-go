...
func OceanAwsLaunchSpec_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOceanAwsLaunchSpec_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OceanAwsLaunchSpec) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OceanAwsLaunchSpec) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OceanAwsLaunchSpec) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OceanAwsLaunchSpec) MoveFromId(id *string) {
...
func (o *jsiiProxy_OceanAwsLaunchSpec) MoveTo(moveTarget *string, index interface{}) {
...
func (o *jsiiProxy_OceanAwsLaunchSpec) MoveToId(id *string) {
...
func (o *jsiiProxy_OceanAwsLaunchSpec) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OceanAwsLaunchSpec) ToHclTerraform() interface{} {
	var returns interface{}
