...
func (o *jsiiProxy_OceanAwsLaunchSpecBlockDeviceMappingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OceanAwsLaunchSpecBlockDeviceMappingsList) Resolve(context cdktf.IResolveContext) interface{} {
