...
type OceanAwsLaunchSpecSchedulingTaskOutputReference interface {
	cdktf.ComplexObject
	...
	TaskHeadroom() OceanAwsLaunchSpecSchedulingTaskTaskHeadroomList
...
// The jsii proxy struct for OceanAwsLaunchSpecSchedulingTaskOutputReference
type jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) CronExpression() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cronExpression",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) CronExpressionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cronExpressionInput",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) IsEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isEnabled",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) IsEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isEnabledInput",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) TaskHeadroom() OceanAwsLaunchSpecSchedulingTaskTaskHeadroomList {
	var returns OceanAwsLaunchSpecSchedulingTaskTaskHeadroomList
	_jsii_.Get(
		j,
		"taskHeadroom",
		&returns,
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) TaskHeadroomInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"taskHeadroomInput",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) TaskType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"taskType",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) TaskTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"taskTypeInput",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewOceanAwsLaunchSpecSchedulingTaskOutputReference_Override(o OceanAwsLaunchSpecSchedulingTaskOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (o *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (o *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) ResetTaskHeadroom() {
	_jsii_.InvokeVoid(
		o,
		"resetTaskHeadroom",
		nil, // no parameters
...
func (o *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OceanAwsLaunchSpecSchedulingTaskOutputReference) ToString() *string {
	var returns *string
