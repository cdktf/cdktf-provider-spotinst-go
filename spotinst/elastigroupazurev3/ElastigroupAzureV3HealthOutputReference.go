...
func (e *jsiiProxy_ElastigroupAzureV3HealthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ElastigroupAzureV3HealthOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
