...
func (e *jsiiProxy_ElastigroupAzureV3ManagedServiceIdentityList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupAzureV3ManagedServiceIdentityList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
