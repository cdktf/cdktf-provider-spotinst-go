...
type ElastigroupAzureV3Signal struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.197.1/docs/resources/elastigroup_azure_v3#timeout ElastigroupAzureV3#timeout}.
