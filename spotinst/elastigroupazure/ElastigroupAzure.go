...
// Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.169.0/docs/resources/elastigroup_azure spotinst_elastigroup_azure} Resource.
...
func ElastigroupAzure_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateElastigroupAzure_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElastigroupAzure) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_ElastigroupAzure) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_ElastigroupAzure) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_ElastigroupAzure) MoveFromId(id *string) {
...
func (e *jsiiProxy_ElastigroupAzure) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_ElastigroupAzure) MoveToId(id *string) {
...
func (e *jsiiProxy_ElastigroupAzure) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_ElastigroupAzure) ToHclTerraform() interface{} {
	var returns interface{}
