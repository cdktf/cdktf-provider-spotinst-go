...
type ElastigroupAzureHealthCheckOutputReference interface {
	cdktf.ComplexObject
	...
	InternalValue() *ElastigroupAzureHealthCheck
	SetInternalValue(val *ElastigroupAzureHealthCheck)
	// Experimental.
...
// The jsii proxy struct for ElastigroupAzureHealthCheckOutputReference
type jsiiProxy_ElastigroupAzureHealthCheckOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) AutoHealing() interface{} {
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) AutoHealingInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoHealingInput",
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) ComplexObjectIndex() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"complexObjectIndex",
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) GracePeriod() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"gracePeriod",
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) GracePeriodInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"gracePeriodInput",
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) HealthCheckType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"healthCheckType",
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) HealthCheckTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) InternalValue() *ElastigroupAzureHealthCheck {
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewElastigroupAzureHealthCheckOutputReference_Override(e ElastigroupAzureHealthCheckOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (e *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (e *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) ResetAutoHealing() {
	_jsii_.InvokeVoid(
		e,
		"resetAutoHealing",
		nil, // no parameters
...
func (e *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) ResetGracePeriod() {
	_jsii_.InvokeVoid(
		e,
		"resetGracePeriod",
		nil, // no parameters
...
func (e *jsiiProxy_ElastigroupAzureHealthCheckOutputReference) ToString() *string {
	var returns *string
