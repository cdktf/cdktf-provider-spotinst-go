...
func (e *jsiiProxy_ElastigroupAwsBeanstalkScheduledTaskList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (e *jsiiProxy_ElastigroupAwsBeanstalkScheduledTaskList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
