...
func (e *jsiiProxy_ElastigroupGkeMetadataList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupGkeMetadataList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
