...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ElastigroupGkeBackendServicesBackendBalancing)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.elastigroupGke.ElastigroupGkeBackendServicesBackendBalancingOutputReference",
		reflect.TypeOf((*ElastigroupGkeBackendServicesBackendBalancingOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ElastigroupGkeShieldedInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.elastigroupGke.ElastigroupGkeShieldedInstanceConfigOutputReference",
		reflect.TypeOf((*ElastigroupGkeShieldedInstanceConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
