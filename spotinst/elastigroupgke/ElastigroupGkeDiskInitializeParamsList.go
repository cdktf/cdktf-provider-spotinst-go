...
func (e *jsiiProxy_ElastigroupGkeDiskInitializeParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElastigroupGkeDiskInitializeParamsList) Resolve(context cdktf.IResolveContext) interface{} {
