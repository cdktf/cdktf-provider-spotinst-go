...
func (e *jsiiProxy_ElastigroupGkeInstanceTypesCustomList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupGkeInstanceTypesCustomList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
