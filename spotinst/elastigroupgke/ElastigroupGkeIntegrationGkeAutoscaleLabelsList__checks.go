...
func (e *jsiiProxy_ElastigroupGkeIntegrationGkeAutoscaleLabelsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupGkeIntegrationGkeAutoscaleLabelsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
