...
func (e *jsiiProxy_ElastigroupGkeDiskInitializeParamsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupGkeDiskInitializeParamsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
