...
func (e *jsiiProxy_ElastigroupGkeScalingDownPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElastigroupGkeScalingDownPolicyList) Resolve(context cdktf.IResolveContext) interface{} {
