...
func NewElastigroupGkeBackendServicesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElastigroupGkeBackendServicesList {
	...
	if err := validateNewElastigroupGkeBackendServicesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElastigroupGkeBackendServicesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElastigroupGkeBackendServicesList) Resolve(context cdktf.IResolveContext) interface{} {
