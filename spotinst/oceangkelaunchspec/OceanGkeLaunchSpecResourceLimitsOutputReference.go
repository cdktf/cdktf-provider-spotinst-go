...
type OceanGkeLaunchSpecResourceLimitsOutputReference interface {
	cdktf.ComplexObject
	...
	// Experimental.
	Fqn() *string
	InternalValue() *OceanGkeLaunchSpecResourceLimits
	SetInternalValue(val *OceanGkeLaunchSpecResourceLimits)
...
// The jsii proxy struct for OceanGkeLaunchSpecResourceLimitsOutputReference
type jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) InternalValue() *OceanGkeLaunchSpecResourceLimits {
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) MaxInstanceCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxInstanceCount",
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) MaxInstanceCountInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) MinInstanceCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minInstanceCount",
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) MinInstanceCountInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewOceanGkeLaunchSpecResourceLimitsOutputReference_Override(o OceanGkeLaunchSpecResourceLimitsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (o *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (o *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) ResetMaxInstanceCount() {
	_jsii_.InvokeVoid(
		o,
		"resetMaxInstanceCount",
		nil, // no parameters
...
func (o *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) ResetMinInstanceCount() {
	_jsii_.InvokeVoid(
		o,
		"resetMinInstanceCount",
		nil, // no parameters
...
func (o *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OceanGkeLaunchSpecResourceLimitsOutputReference) ToString() *string {
	var returns *string
