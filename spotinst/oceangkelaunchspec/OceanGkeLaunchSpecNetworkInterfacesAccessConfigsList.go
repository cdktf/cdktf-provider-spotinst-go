...
func (o *jsiiProxy_OceanGkeLaunchSpecNetworkInterfacesAccessConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OceanGkeLaunchSpecNetworkInterfacesAccessConfigsList) Resolve(context cdktf.IResolveContext) interface{} {
