...
// Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.216.1/docs/resources/ocean_gke_launch_spec spotinst_ocean_gke_launch_spec} Resource.
...
func (o *jsiiProxy_OceanGkeLaunchSpec) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OceanGkeLaunchSpec) MoveFromId(id *string) {
...
func (o *jsiiProxy_OceanGkeLaunchSpec) MoveToId(id *string) {
...
func (o *jsiiProxy_OceanGkeLaunchSpec) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OceanGkeLaunchSpec) ToHclTerraform() interface{} {
	var returns interface{}
