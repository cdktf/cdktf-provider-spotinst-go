...
func (o *jsiiProxy_OceanGkeLaunchSpecSchedulingTaskTaskHeadroomList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OceanGkeLaunchSpecSchedulingTaskTaskHeadroomList) Resolve(context cdktf.IResolveContext) interface{} {
