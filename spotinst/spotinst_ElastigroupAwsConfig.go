...
type ElastigroupAwsConfig struct {
	...
	InstanceTypesOndemand *string `field:"required" json:"instanceTypesOndemand" yaml:"instanceTypesOndemand"`
	...
	IntegrationMultaiRuntime *ElastigroupAwsIntegrationMultaiRuntime `field:"optional" json:"integrationMultaiRuntime" yaml:"integrationMultaiRuntime"`
	...
	MultaiTargetSets interface{} `field:"optional" json:"multaiTargetSets" yaml:"multaiTargetSets"`
