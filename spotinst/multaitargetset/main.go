...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MultaiTargetSet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-spotinst.multaiTargetSet.MultaiTargetSetConfig",
		reflect.TypeOf((*MultaiTargetSetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-spotinst.multaiTargetSet.MultaiTargetSetHealthCheck",
		reflect.TypeOf((*MultaiTargetSetHealthCheck)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.multaiTargetSet.MultaiTargetSetHealthCheckOutputReference",
		reflect.TypeOf((*MultaiTargetSetHealthCheckOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-spotinst.multaiTargetSet.MultaiTargetSetTags",
		reflect.TypeOf((*MultaiTargetSetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.multaiTargetSet.MultaiTargetSetTagsList",
		reflect.TypeOf((*MultaiTargetSetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MultaiTargetSetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
