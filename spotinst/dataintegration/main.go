...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataIntegration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataIntegrationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-spotinst.dataIntegration.DataIntegrationS3",
		reflect.TypeOf((*DataIntegrationS3)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.dataIntegration.DataIntegrationS3OutputReference",
		reflect.TypeOf((*DataIntegrationS3OutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetSubdir", GoMethod: "ResetSubdir"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "subdir", GoGetter: "Subdir"},
			_jsii_.MemberProperty{JsiiProperty: "subdirInput", GoGetter: "SubdirInput"},
