...
func (o *jsiiProxy_OceanEcsClusterOrientationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (o *jsiiProxy_OceanEcsClusterOrientationList) Resolve(context cdktf.IResolveContext) interface{} {
