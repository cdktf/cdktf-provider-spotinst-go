...
func (o *jsiiProxy_OceanEcsScheduledTaskList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (o *jsiiProxy_OceanEcsScheduledTaskList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
