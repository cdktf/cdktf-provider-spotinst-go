...
func (o *jsiiProxy_OceanEcsScheduledTaskTasksList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (o *jsiiProxy_OceanEcsScheduledTaskTasksList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
