...
func (o *jsiiProxy_OceanEcsAutoscalerDownOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanEcsAutoscalerDownOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
