...
func (o *jsiiProxy_OceanEcsBlockDeviceMappingsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (o *jsiiProxy_OceanEcsBlockDeviceMappingsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
