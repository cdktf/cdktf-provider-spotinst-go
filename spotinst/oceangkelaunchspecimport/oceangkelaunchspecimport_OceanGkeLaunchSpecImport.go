...
import (
	...
	"github.com/hashicorp/cdktf-provider-spotinst-go/spotinst/v3/oceangkelaunchspecimport/internal"
...
func (j *jsiiProxy_OceanGkeLaunchSpecImport) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_OceanGkeLaunchSpecImport)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
