...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "minData", GoGetter: "MinData"},
			_jsii_.MemberProperty{JsiiProperty: "minDataInput", GoGetter: "MinDataInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMinData", GoMethod: "ResetMinData"},
