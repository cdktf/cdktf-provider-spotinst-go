...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ElastigroupAwsSuspension)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSuspension", GoMethod: "PutSuspension"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "suspension", GoGetter: "Suspension"},
			_jsii_.MemberProperty{JsiiProperty: "suspensionInput", GoGetter: "SuspensionInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ElastigroupAwsSuspensionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-spotinst.elastigroupAwsSuspension.ElastigroupAwsSuspensionSuspension",
		reflect.TypeOf((*ElastigroupAwsSuspensionSuspension)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.elastigroupAwsSuspension.ElastigroupAwsSuspensionSuspensionList",
		reflect.TypeOf((*ElastigroupAwsSuspensionSuspensionList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ElastigroupAwsSuspensionSuspensionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
