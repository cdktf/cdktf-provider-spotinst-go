...
func (e *jsiiProxy_ElastigroupAwsScalingDownPolicyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupAwsScalingDownPolicyList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
