...
func NewElastigroupAwsScalingUpPolicyStepAdjustmentsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ElastigroupAwsScalingUpPolicyStepAdjustmentsOutputReference {
	...
	if err := validateNewElastigroupAwsScalingUpPolicyStepAdjustmentsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElastigroupAwsScalingUpPolicyStepAdjustmentsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ElastigroupAwsScalingUpPolicyStepAdjustmentsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
