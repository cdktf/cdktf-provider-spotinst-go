...
func (e *jsiiProxy_ElastigroupAwsLoggingExportS3List) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElastigroupAwsLoggingExportS3List) Resolve(context cdktf.IResolveContext) interface{} {
