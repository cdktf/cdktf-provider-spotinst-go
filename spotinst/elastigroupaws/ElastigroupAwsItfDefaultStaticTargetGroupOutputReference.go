...
func NewElastigroupAwsItfDefaultStaticTargetGroupOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ElastigroupAwsItfDefaultStaticTargetGroupOutputReference {
	...
	if err := validateNewElastigroupAwsItfDefaultStaticTargetGroupOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElastigroupAwsItfDefaultStaticTargetGroupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ElastigroupAwsItfDefaultStaticTargetGroupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
