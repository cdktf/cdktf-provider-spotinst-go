...
func (e *jsiiProxy_ElastigroupAwsTagsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupAwsTagsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
