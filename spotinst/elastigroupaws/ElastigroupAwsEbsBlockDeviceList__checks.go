...
func (e *jsiiProxy_ElastigroupAwsEbsBlockDeviceList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupAwsEbsBlockDeviceList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
