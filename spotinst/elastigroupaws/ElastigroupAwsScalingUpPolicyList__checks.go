...
func (e *jsiiProxy_ElastigroupAwsScalingUpPolicyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ElastigroupAwsScalingUpPolicyList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
