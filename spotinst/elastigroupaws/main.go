...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maxReplacementsPercentage", GoGetter: "MaxReplacementsPercentage"},
			_jsii_.MemberProperty{JsiiProperty: "maxReplacementsPercentageInput", GoGetter: "MaxReplacementsPercentageInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaxReplacementsPercentage", GoMethod: "ResetMaxReplacementsPercentage"},
