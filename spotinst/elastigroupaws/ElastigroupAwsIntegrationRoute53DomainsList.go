...
func (e *jsiiProxy_ElastigroupAwsIntegrationRoute53DomainsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElastigroupAwsIntegrationRoute53DomainsList) Resolve(context cdktf.IResolveContext) interface{} {
