...
func (o *jsiiProxy_OceanAwsAutoscalerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanAwsAutoscalerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
