...
func (o *jsiiProxy_OceanAwsLoggingExportOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanAwsLoggingExportOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
