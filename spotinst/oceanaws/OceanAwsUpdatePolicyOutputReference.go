...
func (o *jsiiProxy_OceanAwsUpdatePolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanAwsUpdatePolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
