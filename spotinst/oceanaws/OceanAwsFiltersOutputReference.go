...
func (o *jsiiProxy_OceanAwsFiltersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OceanAwsFiltersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
