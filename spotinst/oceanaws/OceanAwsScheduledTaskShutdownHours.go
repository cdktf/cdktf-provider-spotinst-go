...
type OceanAwsScheduledTaskShutdownHours struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spotinst/spotinst/1.181.1/docs/resources/ocean_aws#time_windows OceanAws#time_windows}.
