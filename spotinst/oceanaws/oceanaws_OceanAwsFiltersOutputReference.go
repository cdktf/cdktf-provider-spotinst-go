...
type OceanAwsFiltersOutputReference interface {
	...
	IsEnaSupported() interface{}
	SetIsEnaSupported(val interface{})
	IsEnaSupportedInput() interface{}
	MaxGpu() *float64
...
func (j *jsiiProxy_OceanAwsFiltersOutputReference) IsEnaSupported() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isEnaSupported",
...
func (j *jsiiProxy_OceanAwsFiltersOutputReference) IsEnaSupportedInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isEnaSupportedInput",
...
func (j *jsiiProxy_OceanAwsFiltersOutputReference)SetIsEnaSupported(val interface{}) {
