...
type ManagedInstanceAwsConfig struct {
	...
	MetadataOptions *ManagedInstanceAwsMetadataOptions `field:"optional" json:"metadataOptions" yaml:"metadataOptions"`
	...
	PreferredTypes *[]*string `field:"optional" json:"preferredTypes" yaml:"preferredTypes"`
