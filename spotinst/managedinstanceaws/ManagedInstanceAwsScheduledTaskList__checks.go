...
func (m *jsiiProxy_ManagedInstanceAwsScheduledTaskList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (m *jsiiProxy_ManagedInstanceAwsScheduledTaskList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
