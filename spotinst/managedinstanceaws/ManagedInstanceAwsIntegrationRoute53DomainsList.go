...
func (m *jsiiProxy_ManagedInstanceAwsIntegrationRoute53DomainsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_ManagedInstanceAwsIntegrationRoute53DomainsList) Resolve(context cdktf.IResolveContext) interface{} {
