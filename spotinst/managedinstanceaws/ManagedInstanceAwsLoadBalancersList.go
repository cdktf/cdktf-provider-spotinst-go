...
type ManagedInstanceAwsLoadBalancersList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ManagedInstanceAwsLoadBalancersOutputReference
...
// The jsii proxy struct for ManagedInstanceAwsLoadBalancersList
type jsiiProxy_ManagedInstanceAwsLoadBalancersList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ManagedInstanceAwsLoadBalancersList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ManagedInstanceAwsLoadBalancersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ManagedInstanceAwsLoadBalancersList) InternalValue() interface{} {
...
func (j *jsiiProxy_ManagedInstanceAwsLoadBalancersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ManagedInstanceAwsLoadBalancersList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ManagedInstanceAwsLoadBalancersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (m *jsiiProxy_ManagedInstanceAwsLoadBalancersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_ManagedInstanceAwsLoadBalancersList) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_ManagedInstanceAwsLoadBalancersList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (m *jsiiProxy_ManagedInstanceAwsLoadBalancersList) ToString() *string {
	var returns *string
