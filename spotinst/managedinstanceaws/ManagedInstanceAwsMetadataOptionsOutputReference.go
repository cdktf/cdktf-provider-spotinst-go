...
func (m *jsiiProxy_ManagedInstanceAwsMetadataOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedInstanceAwsMetadataOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
