...
func (m *jsiiProxy_ManagedInstanceAwsDeleteOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedInstanceAwsDeleteOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
