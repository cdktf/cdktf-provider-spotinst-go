...
func (m *jsiiProxy_ManagedInstanceAwsBlockDeviceMappingsEbsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedInstanceAwsBlockDeviceMappingsEbsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
