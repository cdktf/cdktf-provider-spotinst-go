...
type ManagedInstanceAwsScheduledTaskList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ManagedInstanceAwsScheduledTaskOutputReference
...
// The jsii proxy struct for ManagedInstanceAwsScheduledTaskList
type jsiiProxy_ManagedInstanceAwsScheduledTaskList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ManagedInstanceAwsScheduledTaskList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ManagedInstanceAwsScheduledTaskList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ManagedInstanceAwsScheduledTaskList) InternalValue() interface{} {
...
func (j *jsiiProxy_ManagedInstanceAwsScheduledTaskList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ManagedInstanceAwsScheduledTaskList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ManagedInstanceAwsScheduledTaskList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (m *jsiiProxy_ManagedInstanceAwsScheduledTaskList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_ManagedInstanceAwsScheduledTaskList) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_ManagedInstanceAwsScheduledTaskList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (m *jsiiProxy_ManagedInstanceAwsScheduledTaskList) ToString() *string {
	var returns *string
