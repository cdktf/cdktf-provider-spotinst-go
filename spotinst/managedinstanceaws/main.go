...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fallBackToOd", GoGetter: "FallBackToOd"},
			_jsii_.MemberProperty{JsiiProperty: "fallBackToOdInput", GoGetter: "FallBackToOdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFallBackToOd", GoMethod: "ResetFallBackToOd"},
