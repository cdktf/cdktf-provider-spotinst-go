...
// Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.147.0/docs/resources/multai_routing_rule spotinst_multai_routing_rule} Resource.
...
func MultaiRoutingRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMultaiRoutingRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MultaiRoutingRule) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MultaiRoutingRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MultaiRoutingRule) MoveTo(moveTarget *string, index interface{}) {
