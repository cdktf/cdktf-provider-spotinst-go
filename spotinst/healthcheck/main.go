...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putCheck", GoMethod: "PutCheck"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*HealthCheckCheck)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-spotinst.healthCheck.HealthCheckCheckOutputReference",
		reflect.TypeOf((*HealthCheckCheckOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "timeOutInput", GoGetter: "TimeOutInput"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "unhealthy", GoGetter: "Unhealthy"},
			_jsii_.MemberProperty{JsiiProperty: "unhealthyInput", GoGetter: "UnhealthyInput"},
		},
		func() interface{} {
