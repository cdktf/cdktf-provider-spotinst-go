...
type HealthCheck interface {
	...
	PutCheck(value *HealthCheckCheck)
	ResetCheck()
	ResetId()
	ResetName()
...
func (j *jsiiProxy_HealthCheck) Check() HealthCheckCheckOutputReference {
	var returns HealthCheckCheckOutputReference
	_jsii_.Get(
		j,
		"check",
		&returns,
...
func (j *jsiiProxy_HealthCheck) CheckInput() *HealthCheckCheck {
...
func (j *jsiiProxy_HealthCheck) ProxyAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"proxyAddress",
...
func (j *jsiiProxy_HealthCheck) ProxyAddressInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"proxyAddressInput",
...
func (j *jsiiProxy_HealthCheck) ProxyPort() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"proxyPort",
...
func (j *jsiiProxy_HealthCheck) ProxyPortInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"proxyPortInput",
...
func (j *jsiiProxy_HealthCheck) ResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceId",
...
func (j *jsiiProxy_HealthCheck) ResourceIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/spotinst/spotinst/1.220.2/docs/resources/health_check spotinst_health_check} Resource.
...
func (j *jsiiProxy_HealthCheck)SetProxyAddress(val *string) {
...
func (j *jsiiProxy_HealthCheck)SetProxyPort(val *float64) {
...
func (j *jsiiProxy_HealthCheck)SetResourceId(val *string) {
...
func (h *jsiiProxy_HealthCheck) PutCheck(value *HealthCheckCheck) {
	if err := h.validatePutCheckParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		h,
...
func (h *jsiiProxy_HealthCheck) ResetCheck() {
	_jsii_.InvokeVoid(
		h,
		"resetCheck",
		nil, // no parameters
...
func (h *jsiiProxy_HealthCheck) ResetName() {
	_jsii_.InvokeVoid(
		h,
		"resetName",
		nil, // no parameters
...
func (h *jsiiProxy_HealthCheck) ResetProxyPort() {
	_jsii_.InvokeVoid(
		h,
		"resetProxyPort",
		nil, // no parameters
